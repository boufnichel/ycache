...
/**
 * This is the extension manager of the Ycache extension.
 */
public class YcacheManager extends GeneratedYcacheManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YcacheManager.class.getName());
	 ...
	 */
	public static YcacheManager getInstance()
	{
		return (YcacheManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YcacheConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YcacheManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YcacheManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YcacheManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YcacheManager called, current tenant: " + getTenant().getTenantID());
		}
	}
